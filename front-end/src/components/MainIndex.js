...
const MainIndex = () => {
    ...
    const [color, setColor] = useState("#80D0C7");
    ...
    return (
        <div className='main-parent'>
            {loading ?
                <PuffLoader color={color} loading={loading} size={150} aria-label="Loading Spinner" />
                :
                <motion.div
                    className='first__array'
